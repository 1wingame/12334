"use strict";
(self.webpackChunkcoin_flip_app_ts = self.webpackChunkcoin_flip_app_ts || []).push([[5330], {
    5960: function(e, t, n) {
        n.r(t),
        n.d(t, {
            MinesPage: function() {
        ...
        var s = n(2791)
          ...
          , T = n.n(N)
          , E = function(e, t) {
            switch (T().info("ACTION: ", f.M[t.type]),
            T().info("PAYLOAD: ", t.payload),
            t.type) {
            case f.M.SET_USER:
                return (0,
                j.Z)((0,
            ...
            case f.M.SET_LIVE_BETS_CONNECTED:
                ...
                j.Z)({}, e), {}, {
                    liveBets: (0,
                    j.Z)((0,
                    j.Z)({}, e.liveBets), t.payload)
                });
            case f.M.SET_LIVE_BETS:
                var s, r = t.payload, i = r.data;
                return (s = Array.isArray(i) ? i : [(0,
                j.Z)((0,
                j.Z)({}, i), {}, {
                    bet: i.bet,
                    resultBalance: i.resultBalance
                })].concat((0,
                C.Z)(e.liveBets.list))).length > 20 && (s = s.slice(0, 20)),
                (0,
                j.Z)((0,
                j.Z)({}, e), {}, {
                    liveBets: (0,
        ...
        s.createContext)({
          ...
          , L = function(e) {
                            ...
                            r.Z)().wrap((function(e) {
                                for (; ; )
                                    ...
                                    case 3:
                                        ...
                                        return e.next = 7,
                                        n.fetchSessionData(t.data[0].id);
                                    case 7:
                                        e.next = 13;
                                        break;
                                    case 9:
                        ...
                        r.Z)().mark((function e() {
                            ...
                            r.Z)().wrap((function(e) {
                                for (; ; )
                                    ...
                                    case 4:
                                        e.t2 = e.sent,
                                        e.t3 = e.t1.updateSessions.call(e.t1, e.t2),
                                        (0,
                                        e.t0)(e.t3);
                                    case 7:
                                    case "end":
            ...
            s.useEffect)((function() {
                var e = (0,
                _.io)("".concat("https://prod-rnd-websocket-php.100hp.app/mines"), {
          ...
          , P = function() {
            ...
            s.useContext)(R);
            if (void 0 === e)
                throw new Error("useMinesContext must be used within a MinesStateProvider");
            return e
        }
          , U = n(3856)
          , I = n(3168)
          ...
          , fe = n(7454)
          , pe = function(e) {
            return e[e.cellHide = 0] = "cellHide",
            e[e.cellShow = 1] = "cellShow",
            e[e.cellTap = 2] = "cellTap",
            e[e.resultShow = 3] = "resultShow",
            e[e.resultHide = 4] = "resultHide",
            e
        }({})
          , ve = function(e, t) {
            var n = (0,
          ...
          , me = function(e) {
            ...
            s.useEffect)((function() {
                ...
                void 0 !== t || l || (d((function(e) {
                    return !e
                }
                )),
                p.play(pe.resultHide, 0),
                setTimeout((function() {
                    return p.play(pe.cellShow)
                }
                ), 1e3))
          ...
          , Se = function(e) {
            ...
            var g = function() {
                S(Z.map((function(e) {
                    return e.category = xe(u.session.gameData.userChoices, e.value),
                    e
                }
                )))
            };
            (0,
            s.useEffect)((function() {
                w.current < u.session.lastRound && (g(),
                w.current = u.session.lastRound)
            }
            ), [u.session.lastRound]),
            (0,
            s.useEffect)((function() {
                if (l.isSessionFinished)
                    return S(Ze(u.session.gameData.expectedChoices)),
                    h(!1),
                    void setTimeout((function() {
                        h(!0),
                        re.restart.audio.play()
                    }
                    ), t);
                var e;
                ...
                (null === (e = u.session.gameData.userChoices) || void 0 === e ? void 0 : e.length) > 0 && g(),
                o(!1))
            }
            ), [u.session.state]);
            var k = (0,
            s.useCallback)((function(e, t) {
                ...
                S(Z.map((function(t) {
                    var s, r, i, a;
                    return (null === (s = t.value) || void 0 === s ? void 0 : s.col) === (null === (r = e.value) || void 0 === r ? void 0 : r.col) && (null === (i = t.value) || void 0 === i ? void 0 : i.row) === (null === (a = e.value) || void 0 === a ? void 0 : a.row) && (t.category = n.category),
                    t
                }
                ))),
                    ...
                    r.Z)().wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                return re.click.audio.play(),
                                e.prev = 3,
                                e.next = 6,
                                null === d || void 0 === d ? void 0 : d.finishActiveRound(t.value);
                            case 6:
                                (n = e.sent) && (k(t, n),
                                w.current += 1,
                                null === d || void 0 === d || d.fetchSessionData(u.session.id)),
                                e.next = 16;
                                break;
                            case 10:
                                e.prev = 10,
                                e.t0 = e.catch(3),
                                e.t0.type !== ue.V[ue.V.sessionExpired] && e.t0.type !== ue.V[ue.V.changedCurrency] && e.t0.message !== de.FG || (null === d || void 0 === d || d.clearSession(),
                                null === d || void 0 === d || d.fetchUserData(),
                                ce.ZP.set(".cells-board-mask", {
                                    display: "block",
                                    zIndex: "2"
                                }),
                                e.t0.message === de.FG && fe.R0.serverError()),
                                "Round with this column and row already exists" === e.t0.message && (null === d || void 0 === d || d.fetchSessionData(u.session.id)),
                                (0,
                                F.d)(e.t0, y),
                                o(!1);
                            case 16:
          ...
          , ye = n(9444)
          , ge = function() {
            var e, t, n, o, c, u, l = P(), f = l.state, p = l.computed, v = l.controller, h = (0,
            s.useState)(!1), m = (0,
            a.Z)(h, 2), x = m[0], Z = m[1], S = (0,
            s.useState)(0), b = (0,
            a.Z)(S, 2), w = b[0], y = b[1], g = (0,
            s.useState)(0), k = (0,
            a.Z)(g, 2), C = k[0], N = k[1], T = (0,
            s.useState)(!1), E = (0,
            a.Z)(T, 2), _ = E[0], A = E[1], D = (0,
            I.$)().t, B = (0,
            s.useState)(!0), H = (0,
            a.Z)(B, 2), R = H[0], L = H[1], G = null !== (e = null === (t = f.settings.bets[f.user.currency]) || void 0 === t ? void 0 : t.quickBets) && void 0 !== e ? e : {
                min: 10,
                max: 100
            }, W = function() {
                var e = (0,
                    ...
                    r.Z)().wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                return Z(!0),
                                e.next = 3,
                                null === v || void 0 === v ? void 0 : v.initGame();
                            case 3:
                                return e.next = 5,
                                null === v || void 0 === v ? void 0 : v.checkActiveSession();
                            case 5:
                                Z(!1),
                                L(!1);
                            case 7:
            ...
            s.useEffect)((function() {
                var e;
                N((0,
                ie.xC)(null !== (e = f.settings.presets) && void 0 !== e ? e : []))
            }
            ), [f.settings.presets]);
            var V = (0,
            s.useCallback)((0,
                ...
                r.Z)().wrap((function(e) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            e.prev = 2,
                            e.next = 5,
                            null === v || void 0 === v ? void 0 : v.startSession(w, C);
                        case 5:
                            Z(!1),
                            re.gloss.audio.play(),
                            ce.ZP.fromTo(".animated-highlight", {
                                x: -170,
                                y: 50
                            }, {
                                x: 550,
                        ...
                        case 11:
                            ...
                            (0,
                            F.d)(e.t0, D),
                            "Active session already exists" !== e.t0.message) {
                                e.next = 20;
                                break
                            }
                            return e.next = 17,
                ...
                r.Z)().wrap((function(e) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            e.prev = 2,
                            e.next = 5,
                            null === v || void 0 === v ? void 0 : v.finishSession();
                        case 5:
                            re.cashout.audio.play(),
                            ae.C.Vp.winRound(f.session.availableCashout, d.F[f.session.currency], f.session.coefficient),
                            null === v || void 0 === v || v.fetchUserData(),
                            e.next = 15;
                            break;
                        case 10:
                            e.prev = 10,
                            e.t0 = e.catch(2),
                            e.t0.type !== ue.V[ue.V.sessionExpired] && "Invalid session state for cashout" !== e.t0.message || (null === v || void 0 === v || v.clearSession(),
                            null === v || void 0 === v || v.fetchUserData(),
                            ce.ZP.set(".cells-board-mask", {
                                display: "block",
                                zIndex: "2"
            ...
            s.useEffect)((function() {
                p.isFullWin && (Z(!0),
                null === v || void 0 === v || v.finishSession(),
                setTimeout((function() {
                    return A(!0)
                }
                ), 2700))
            ...
            (0,
            s.useEffect)((function() {
                p.isSessionFinished && (Z(!0),
                setTimeout((function() {
                    null === v || void 0 === v || v.clearSession(),
                    null === v || void 0 === v || v.fetchHistory(),
                    Z(!1),
                    ce.ZP.set(".cells-board-mask", {
                        display: "block",
                        zIndex: "2"
                ...
                M.jsxs)("div", {
                    ...
                    M.jsxs)("div", {
                        ...
                        M.jsxs)("div", {
                            ...
                            M.jsx)(l.z, {
                                ...
                                isGameWithMusic: !1,
                                balance: "".concat(t.user.balance, " ").concat(d.F[t.user.currency])
                            })]
                        }), (0,
                        M.jsx)(ge, {}), (0,
                        M.jsx)("div", {
                    ...
                    M.jsx)("div", {
                        ...
                        M.jsx)(o.A, {
                            ...
                            myHistoryContent: (0,
                            M.jsx)(c.G, {
                                list: t.sessions.data,
                                gameApi: y
                            }),
                            liveBetsContent: (0,
                            M.jsx)(u.O, {
                                list: t.liveBets.list
                            })
                        })
                    })]
                })
...
//# sourceMappingURL=5330.05479c86.chunk.js.map
