(self.webpackChunkcoin_flip_app_ts = self.webpackChunkcoin_flip_app_ts || []).push([[1463], {
    5523: function(n, o, s) {
        "use strict";
        s.d(o, {
            J: function() {
        ...
        var e = s(3433)
          ...
          , j = function(n) {
            ...
            i.useCallback)((function() {
                ...
                "big" === m && k((function(n) {
                    var o = [].concat((0,
                    e.Z)(n), ["games-".concat(null !== c && void 0 !== c ? c : "blue", "-bg")]);
                    return "orange" === c ? o.push("main-light-text cashout") : o.push("text-white"),
                    o
                }
                ))
            }
            ...
            l.jsx)("button", {
                ...
                disabled: h,
                className: (0,
                t.Z)("app-button", u, x, "".concat(h ? "cursor-not-allowed" : "cursor-pointer"), {
                    block: C,
                    "h-full": f,
                    "w-full": w
                }),
    ...
    4535: function(n, o, s) {
        ...
        var e = s(2791)
          ...
          , v = function(n) {
            var o, s = n.toggleModalAboutGame, e = n.isGameWithMusic, r = n.togglePlayMusic, t = n.isPlayMusic, l = n.balance, j = n.sx;
            return (0,
            i.jsx)("div", {
    ...
    6761: function(n, o, s) {
        ...
        var e = s(1426)
          ...
          , l = function(n) {
            ...
            return n && o.length && o.splice(2, 1, o[2].slice(2)),
            o.join(".")
        }
    },
    8077: function(n, o, s) {
        ...
        var e, r = s(6761), i = s(6662), t = s(8589), l = s(5733), j = s(8825), u = {
            lng: null !== (e = (0,
            r.G3)()) && void 0 !== e ? e : "en",
            interpolation: {
                escapeValue: !1
    ...
    4761: function(n, o, s) {
        ...
        var e = function(n) {
            return n[n["Not started"] = 0] = "Not started",
            n[n.Active = 1] = "Active",
            n[n.Inactive = 2] = "Inactive",
            n[n.Win = 3] = "Win",
            n[n.Loss = 4] = "Loss",
            n[n.Planned = 5] = "Planned",
            n
        }({})
          , r = function(n) {
            return n.EUR = "\u20ac",
            ...
            e.Z)().mark((function n(o) {
                ...
                e.Z)().wrap((function(n) {
                    for (; ; )
                        ...
                        case 0:
                            return a = h.length > 1 && void 0 !== h[1] && h[1],
                            c = {
                                lng: null !== (i = (0,
                                j.G3)()) && void 0 !== i ? i : "en",
                                interpolation: {
                            ...
                            d = t.ZP.createInstance(),
                            n.next = 5,
                            d.use(l.Db).use(u.A).use((0,
                            C.Z)((function(n, e, i) {
