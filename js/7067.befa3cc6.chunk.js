"use strict";
(self.webpackChunkcoin_flip_app_ts = self.webpackChunkcoin_flip_app_ts || []).push([[7067], {
    5196: function(t, e, n) {
        n.d(e, {
            Hg: function() {
                return r
        ...
        var a, u, c, l, d, p = n(4165), f = n(5861), C = n(2659), h = "/coin/session", x = (0,
        C.p8)(null !== (a = "https://prod-rnd-backend-php.100hp.app") ? a : ""), v = function() {
            var t = (0,
            f.Z)((0,
            p.Z)().mark((function t() {
                return (0,
        ...
        }(), _ = "/double/session", A = "/double/round", L = (0,
        C.p8)(null !== (u = "https://prod-rnd-backend-php.100hp.app") ? u : ""), S = function() {
            var t = (0,
            f.Z)((0,
            p.Z)().mark((function t() {
                return (0,
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.get("/double/settings"));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t() {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.get("/double/user"));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.get("".concat(_, "/").concat(e)));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.get("".concat(_, "/").concat(e, "/stats")));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.put(A, e));
                        case 1:
                        case "end":
                            return t.stop()
                        }
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            t.abrupt("return", L.get("".concat("/double/sessions", "?filter=").concat(r), {
                                params: e
                            }));
                        case 2:
                        case "end":
            ...
            p.Z)().mark((function t() {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", L.delete(A));
                        case 1:
                        case "end":
                            return t.stop()
                        }
        ...
        C.p8)(null !== (c = "https://prod-rnd-backend-php.100hp.app") ? c : ""), O = function() {
            var t = (0,
            f.Z)((0,
            p.Z)().mark((function t() {
                return (0,
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.get("/mines/user"));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t() {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.get("/mines/settings"));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.get("".concat(V, "/").concat(e)));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.put("".concat(V, "/").concat(e)));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.post(V, e));
                        case 1:
                        case "end":
                            return t.stop()
                        }
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.put("/mines/round", e));
                        case 1:
                        case "end":
                            return t.stop()
                        }
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            t.abrupt("return", F.get("".concat("/mines/sessions").concat(n ? r : ""), {
                                params: e
                            }));
                        case 2:
                        case "end":
            ...
            p.Z)().mark((function t(e) {
                ...
                p.Z)().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return t.abrupt("return", F.get("".concat(V, "/").concat(e, "/stats")));
                        case 1:
                        case "end":
                            return t.stop()
                        }
        ...
        C.p8)(null !== (l = "https://prod-rnd-backend-php.100hp.app") ? l : ""), q = function() {
            var t = (0,
            f.Z)((0,
            p.Z)().mark((function t() {
                return (0,
        ...
        "".concat(et, "/history"),
        "".concat(et, "/roll"),
        "".concat(et, "/get_active_game"),
        "".concat(et, "/user/balance"),
        (0,
        C.p8)(null !== (d = "https://prod-rnd-backend-php.100hp.app") ? d : "")
    },
    2659: function(t, e, n) {
        n.d(e, {
            FG: function() {
        ...
        var r, i, s = n(4165), o = n(5861), a = n(1044), u = n(6761), c = n(1468), l = n(3144), d = n(5671), p = n(136), f = n(9388), C = "one-play-handshake", h = n(1752), x = n(1120), v = function(t) {
            (0,
            p.Z)(n, t);
            var e = (0,
            f.Z)(n);
            function n() {
                ...
                return t.addPort(r.port1),
                window.parent.postMessage(C, "*", [r.port2]),
                t
            }
            return (0,
            l.Z)(n)
            ...
            l.Z)(n, [{
                ...
                value: function(t) {
                    ...
                    (0,
                    h.Z)((0,
                    x.Z)(n.prototype), "emit", this).call(this, e.name, e.payload)
                }
            }, {
                key: "emit",
                value: function(t, e) {
                    ...
                    (0,
                    h.Z)((0,
                    x.Z)(n.prototype), "emit", this).call(this, t, e)
                }
            }]),
            n
        }(function() {
            ...
            t
        }())), m = window.webkit, g = window.androidBridge, w = function(t) {
            var e = t.name
              , n = t.payload
              , r = JSON.stringify({
                name: e,
        ...
        }, j = n(4423), y = n(7454), Z = function(t, e, n) {
            switch (t.message) {
        ...
        }, b = new v, _ = [j.V[2], j.V[3], j.V[4], j.V[5]], A = null !== (r = null === (i = document.querySelector('meta[name="csrf-token"]')) || void 0 === i ? void 0 : i.getAttribute("content")) && void 0 !== r ? r : null, L = function(t, e, n) {
            var r = a.ZP.create({
                timeout: 2e4,
                baseURL: t,
                headers: {
            ...
            return r.interceptors.request.use((function(t) {
                return t.headers ? (t.headers["x-auth-token"] = (0,
                u.He)(),
                "post" !== t.method && "put" !== t.method || "demo" !== t.headers["x-auth-token"] || (b.emit("authorization_error", null),
                w({
                ...
                s.Z)().mark((function t(r) {
                    ...
                    s.Z)().wrap((function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                            case 0:
                                if ("ERR_NETWORK" !== r.code || window.navigator.onLine || (e ? e.noInternetDebounced() : c.C.R0.noInternet()),
                                400 !== (null === r || void 0 === r || null === (i = r.response) || void 0 === i ? void 0 : i.status) && 500 !== (null === r || void 0 === r || null === (o = r.response) || void 0 === o ? void 0 : o.status)) {
                                    t.next = 13;
                                    break
                                }
                                ...
                                if (l = null === r || void 0 === r || null === (u = r.response) || void 0 === u ? void 0 : u.data.error,
                                !n || !e) {
                                    t.next = 11;
                                    break
                                }
    ...
    7793: function(t, e, n) {
        ...
        r.createContext)(null)
          ...
          , o = function() {
            ...
            r.useContext)(i);
            if (!t)
                throw new Error("Can not use 'useBetPanelContext' outside of the BetPanelProvider");
            return t
        }
    },
    2140: function(t, e, n) {
        ...
        var r = n(9439)
          ...
          , a = n(184)
          , u = function(t) {
            var e, n = t.autoBet, u = t.setAutoBet, c = t.autoBetCountChange, l = t.autoBetCount, d = t.fieldDisabled, p = t.sx, f = (0,
            o.$)().t, C = (0,
            i.useState)(!0), h = (0,
            r.Z)(C, 2), x = h[0], v = h[1];
            return (0,
            ...
            a.jsx)("div", {
                ...
                a.jsxs)("div", {
                    ...
                    a.jsxs)("div", {
                        className: (0,
                        s.Z)("bet-panel__auto-betting__field base-input flex-1 ".concat(null !== (e = null === p || void 0 === p ? void 0 : p.autoBetInputClass) && void 0 !== e ? e : ""), {
                            active: n
                        }),
                        children: [(0,
                        a.jsx)("div", {
    ...
    1681: function(t, e, n) {
        ...
        i.forwardRef)((function(t, e) {
            ...
            o.jsxs)("div", {
                className: (0,
                s.Z)("app-input flex flex-1 justify-center", null === d || void 0 === d ? void 0 : d.inputClass),
                children: [(0,
                o.jsx)("input", {
                    ref: e,
                    id: "amount_field",
        ...
        var r = n(3433)
          ...
          , l = function(t) {
            ...
            s.useEffect)((function() {
                f([["min", n.min]].concat((0,
                r.Z)(Object.entries(n).filter((function(t) {
          ...
          , v = function(t) {
            ...
            return h.GC[r.state] === h.GC["Not started"] ? (0,
            u.jsx)(p.W, {
                id: "play_btn",
                disabled: e,
                onClick: s
            }) : r.availableCashout ? (0,
            u.jsx)(f.M, {
                currency: r.currency,
          ...
          , g = function(t) {
            ...
            u.jsxs)("button", {
                ...
                onClick: o,
                className: (0,
                m.W)("bet-panel__control", "".concat("withoutBG" === c ? "" : "w-[38px] h-[38px] bg-[#151B2E] rounded-lg m-[7px]")),
                children: [(0,
                u.jsx)("div", {
                    className: (0,
                    m.W)("".concat(a ? "bet-panel__control-border" : ""), "".concat(r))
                }), (0,
                u.jsx)("span", {
        ...
        var w = n(2669)
          ...
          , A = function() {
            ...
            o.$)().t
              ...
              , A = (0,
            s.useCallback)(y.ZP.debounce(j.wJ, 700, !0), [v])
              , S = function() {
                a && a();
                var t = n.amount / 2;
                if (t < r.minBet)
              ...
              , k = function() {
                ...
                var t = 2 * n.amount;
                if (0 !== t)
                    return t > c && t < r.maxBet ? (A("noFunds", v),
                    void m(c)) : t > r.maxBet ? (A("high", v),
                    void m(r.maxBet)) : void m(t);
                m(r.minBet)
            };
            (0,
            s.useEffect)((function() {
            ...
            u.jsx)("div", {
                ...
                children: function() {
                    var t, i;
                    if (h.GC[e.state] === h.GC["Not started"])
                        return (0,
                        u.jsxs)("div", {
                            className: "flex w-full",
                            children: [(0,
                    ...
                    if (null !== (t = n.alternativeShowBetAmountState) && void 0 !== t && t.enable) {
                        if (n.alternativeShowBetAmountState.isShow)
                            return M()
                    } else if (h.GC[e.state] === h.GC.Active)
                        return M();
                    if (null !== (i = n.alternativeShowResultState) && void 0 !== i && i.enable) {
                        if (n.alternativeShowResultState.win)
                            return (0,
                            u.jsx)(L, {
                                isWin: !0
                            });
                        if (n.alternativeShowResultState.lose)
                            return (0,
                            u.jsx)(L, {
                                isWin: !1
                            })
                    } else {
                        if (h.GC[e.state] === h.GC.Win)
                            return (0,
                            u.jsx)(L, {
                                isWin: !0
                            });
                        if (h.GC[e.state] === h.GC.Loss)
                            return (0,
                            u.jsx)(L, {
                                isWin: !1
                            })
          ...
          , H = function() {
            var t, e, n, r, i, s, o, a, c, p, f, C, m, g, j, y = (0,
            x.H)(), Z = y.session, b = y.bet, L = y.addons, S = y.roundType, k = y.isLoading, M = y.onClickSound, B = y.betAmountIsValid, H = y.sx, N = h.GC[Z.state] === h.GC.Active, V = null !== (t = null === L || void 0 === L || null === (e = L.quickBets) || void 0 === e ? void 0 : e.isEnabled) && void 0 !== t && t, F = null !== (n = null === L || void 0 === L || null === (r = L.quickBets) || void 0 === r ? void 0 : r.bets) && void 0 !== n ? n : E, O = null !== (i = null === L || void 0 === L || null === (s = L.autoBets) || void 0 === s ? void 0 : s.isEnabled) && void 0 !== i && i, U = null !== (o = null === L || void 0 === L || null === (a = L.autoBets) || void 0 === a ? void 0 : a.count) && void 0 !== o ? o : "", I = null !== (c = null === L || void 0 === L || null === (p = L.autoBets) || void 0 === p ? void 0 : p.checked) && void 0 !== c && c, R = null === L || void 0 === L || null === (f = L.autoBets) || void 0 === f ? void 0 : f.toggleChecked, G = null === L || void 0 === L || null === (C = L.autoBets) || void 0 === C ? void 0 : C.setCount, T = null !== (m = null === L || void 0 === L || null === (g = L.autoBets) || void 0 === g ? void 0 : g.fieldDisabled) && void 0 !== m && m;
            return (0,
            u.jsxs)("div", {
                className: "bet-panel ".concat(null !== (j = null === H || void 0 === H ? void 0 : H.betPanelClass) && void 0 !== j ? j : ""),
                children: [(0,
                u.jsx)("div", {
                    ...
                    u.jsxs)("div", {
                        ...
                        u.jsx)("div", {
                            className: "basis-2/3",
                            children: S === w.V0.single ? (0,
                            u.jsx)(y.BetPanelFieldComponent, {}) : (0,
                            u.jsx)(A, {})
                        }), (0,
                        u.jsx)("div", {
                            className: "basis-1/3 pl-2 mobile:pl-0 mobile:basis-auto mobile:h-[3.25rem]",
                            children: S === w.V0.single ? (0,
                            u.jsx)(y.BetPanelButtonComponent, {}) : (0,
                            u.jsx)(v, {
                                disabled: k || !B
                            })
                        })]
                ...
                u.jsx)(l, {
                    onClick: function(t, e) {
                        ...
                        Number.isNaN(Number(e)))
                            ...
                            var n = parseFloat(b.amount.toString()) + parseFloat((0,
                            w.TC)(t));
                            b.onChangeAmount(n)
                        }
                    },
    ...
    6315: function(t, e, n) {
        ...
        var r = n(1413)
            ...
            return Object.keys(t).forEach((function(r) {
                ...
                case "1/2":
                    var o = parseInt(e.toString(), 10)
                      , a = "";
                    if (!Number.isNaN(o) && BigInt(o) > Number.MAX_SAFE_INTEGER)
                        a = String(BigInt(o) / BigInt(2));
                    else {
                        var u = Number(e) / 2
                          , c = parseFloat(t.min);
                        u < c && (u = c),
          ...
          , o = function(t, e) {
            ...
            var n = Number(t);
            if (Number.isNaN(n))
                throw new Error("amount arg is not a number");
    ...
    8665: function(t, e, n) {
        ...
        var r = n(1413)
          ...
          , c = function(t) {
            ...
            var m = function(t) {
                "ArrowRight" === t.key ? h < p.length - 1 && (x(h + 1),
                d && d()) : "ArrowLeft" === t.key ? h > 0 && (x(h - 1),
                d && d()) : "Escape" === t.key && n()
            }
              , g = function(t) {
                x(t),
                                ...
                                u.jsxs)("div", {
                                    ...
                                    u.jsxs)("div", {
                                        ...
                                        u.jsxs)("div", {
                                            ...
                                            u.jsx)("div", {
                                                className: (0,
                                                o.W)("carousel-controls__prev", !p[h - 1] && "disabled"),
                                                onClick: function() {
                                                    x(h - 1),
                                                    d && d()
                                                },
                                            ...
                                            u.jsx)("div", {
                                                ...
                                                className: (0,
                                                o.W)("carousel-controls__next", !p[h + 1] && "disabled"),
                                                onClick: function() {
                                                    x(h + 1),
                                                    d && d()
                                                },
                ...
                a.jsxs)("div", {
                    ...
                    a.jsxs)("div", {
                        ...
                        a.jsx)("div", {
                            ...
                            role: "button",
                            className: (0,
                            o.W)("header-buttons__item", "feed" === f && "active"),
                            tabIndex: 0,
                            onClick: function() {
                                return C("feed")
                            },
                        ...
                        a.jsx)("div", {
                            ...
                            role: "button",
                            className: (0,
                            o.W)("header-buttons__item", "history" === f && "active"),
                            tabIndex: 0,
                            onClick: function() {
                                return C("history")
                            },
    ...
    9444: function(t, e, n) {
        ...
        var r, i, s, o, a, u, c, l, d = n(2791), p = ["title", "titleId"];
        function f() {
        ...
        var x, v, m, g, w, j = d.forwardRef(h), y = (n.p,
        ["title", "titleId"]);
        function Z() {
        ...
        var A = d.forwardRef(_)
          , L = (n.p,
        n(184))
          , S = function(t) {
            return t.LUCKY_STAR = "lucky_star",
            t
        }({})
          , k = function() {
            var t = "true";
    ...
    4423: function(t, e, n) {
        ...
        var r = function(t) {
            return t[t.changedCurrency = 0] = "changedCurrency",
            t[t.sessionExpired = 1] = "sessionExpired",
            t[t.insufficientFunds = 2] = "insufficientFunds",
            t[t.currencyNotSupported = 3] = "currencyNotSupported",
            t[t.highBid = 4] = "highBid",
            t[t.lowBid = 5] = "lowBid",
            t[t.smthWentWrong = 6] = "smthWentWrong",
            t
        }({})
    },
    7454: function(t, e, n) {
          ...
          , p = (n(5251),
        {
          ...
          , f = {
            ...
            noInternet: d.ZP.debounce((function() {
                this.default((0,
                s.t)("OnLineErrorHeader"), (0,
                s.t)("OnLineErrorBody"), "wifi")
            }
            ), 2e3, !0),
            serverError: function(t) {
                t ? this.default(t("Server error"), t("There was a problem connecting to the server. Try again later.")) : this.default((0,
                s.t)("Server error"), (0,
                s.t)("There was a problem connecting to the server. Try again later."), "wifi")
            },
            noFunds: function(t) {
                t ? this.default(t("Insufficient funds"), t("To make a bet, top-up the balance."), "money") : this.default((0,
                s.t)("Insufficient funds"), (0,
                s.t)("To make a bet, top-up the balance."), "money")
            },
            currencyNotSupported: function(t) {
                t ? this.default(t("Currency isn't supported"), t("Please choose the available one."), "money") : this.default((0,
                s.t)("Currency isn't supported"), (0,
                s.t)("Please choose the available one."), "money")
            },
            smallBid: function(t) {
                t ? this.default(t("Try to bid higher"), t("Your bid is lower than the minimum."), "money") : this.default((0,
                s.t)("Try to bid higher"), (0,
                s.t)("Your bid is lower than the minimum."), "money")
            },
            highBid: function(t) {
                t ? this.default(t("Try to bid lower"), t("Your bid is higher than the maximum."), "money") : this.default((0,
                s.t)("Try to bid lower"), (0,
                s.t)("Your bid is higher than the maximum."), "money")
            },
            incognitoMode: function(t) {
                t ? this.default(t("Incognito mode"), t("Switch to the normal version of the browser for the correct display of the game.")) : this.default((0,
                s.t)("Incognito mode"), (0,
                s.t)("Switch to the normal version of the browser for the correct display of the game."))
            }
        }
          , C = {
    ...
    5611: function(t, e, n) {
        ...
        var r = n(4165)
          ...
          , m = n.n(v);
        function g(t, e) {
            switch (m().info("ACTION: ", x.Gi[e.type]),
            m().info("PAYLOAD: ", e.payload),
            e.type) {
            case x.Gi.UPDATE_SESSION:
                return Array.isArray(e.payload) ? t : (0,
                o.Z)((0,
                o.Z)({}, t), {}, {
                    session: (0,
                    o.Z)({}, e.payload)
            ...
            case x.Gi.SET_LIVE_BETS:
                var r = e.payload
                  , i = [];
                return r.firstList ? i = r.list : (i = (0,
                h.Z)(t.liveBets.list),
        ...
        a.createContext)({
          ...
          , b = function(t) {
            ...
            a.useEffect)((function() {
                var t = (0,
                u.io)("".concat("https://prod-rnd-websocket-php.100hp.app/coin"), {
    ...
    2433: function(t, e, n) {
        ...
        var r = function(t) {
            return t[t.UPDATE_SETTINGS = 0] = "UPDATE_SETTINGS",
            t[t.UPDATE_SESSION = 1] = "UPDATE_SESSION",
            t[t.UPDATE_USER_DATA = 2] = "UPDATE_USER_DATA",
            t[t.SET_LIVE_BETS = 3] = "SET_LIVE_BETS",
            t[t.SET_LIVE_BETS_CONNECTED = 4] = "SET_LIVE_BETS_CONNECTED",
            t[t.SET_HISTORY = 5] = "SET_HISTORY",
            t
        }({})
          , i = function(t) {
            return {
                    ...
                    r.Z)().mark((function s(u, c) {
                        ...
                        r.Z)().wrap((function(r) {
                            for (; ; )
                                ...
                                case 0:
                                    return r.next = 2,
                                    o.k.finishRound(u, String(null === (l = n.activeRound) || void 0 === l ? void 0 : l.id), null !== c && void 0 !== c ? c : String(t.session.id));
                                case 2:
                                    return d = r.sent,
                                    e((0,
                                    a.CT)((0,
                        ...
                        r.Z)().wrap((function(e) {
                            for (; ; )
                                ...
                                case 5:
                                    ...
                                    l.fetchSessionData();
                                case 7:
                                    window.sessionStorage.setItem("previousAmount", String(t.session.rounds[0].amount)),
                                    e.next = 13;
                                    break;
                                case 10:
                                    e.prev = 10,
                        ...
                        r.Z)().wrap((function(e) {
                            for (; ; )
                                ...
                                case 0:
                                    return e.prev = 0,
                                    e.next = 3,
                                    o.k.finishSession(String(t.session.id));
                                case 3:
                                    o.C.Vp.winRound(n.previousRound.availableCash, f.F[t.user.currency], n.previousRound.odd),
                                    e.next = 9;
                                    break;
                                case 6:
                                    e.prev = 6,
                                    e.t0 = e.catch(0),
                                    d().log("ERROR WHILE FINISHING SESSION: ", e.t0);
                                case 9:
                                    return e.prev = 9,
                                    e.next = 12,
                                    l.flushSession();
        ...
        var r = n(5251)
          ...
          , o = function(t) {
            navigator.clipboard ? navigator.clipboard.writeText(t).then((function() {
                ...
                i().error("Async: Could not copy text: ", e),
                s(t)
            }
            )) : s(t)
        }
    ...
    2205: function(t, e, n) {
        ...
        function a(t, e) {
            ...
            default:
                o().error((0,
                i.t)("SomethingWentWrong"), t.message)
            }
        }
    },
    1435: function(t) {
...
//# sourceMappingURL=7067.befa3cc6.chunk.js.map
