/*! For license information please see 1845.e103b46f.chunk.js.LICENSE.txt */
(self.webpackChunkcoin_flip_app_ts = self.webpackChunkcoin_flip_app_ts || []).push([[1845], {
    1845: function(e, n, t) {
        var o;
        !function() {
            "use strict";
            ...
            i.prototype = {
                    ...
                    if (!(s >= p)) {
                        ...
                        if (t._webAudio) {
                            var h = function() {
                                ...
                                "undefined" === typeof m.bufferSource.start ? u._loop ? m.bufferSource.noteGrainOn(0, s, 86400) : m.bufferSource.noteGrainOn(0, s, _) : u._loop ? m.bufferSource.start(0, s, 86400) : m.bufferSource.start(0, s, _),
                            ...
                            "running" === a.state && "interrupted" !== a.ctx.state ? h() : (t._playLock = !0,
                            t.once("resume", h),
                            t._clearTimer(u._id))
                        } else {
                            var y = function() {
                                ...
                                try {
                                    ...
                                    o.then((function() {
                                        t._playLock = !1,
                                        m._unlocked = !0,
                                        n ? t._loadQueue() : t._emit("play", u._id)
                                    }
                                    )).catch((function() {
                                        t._playLock = !1,
                ...
                mute: function(e, n) {
                    ...
                    for (var o = t._getSoundIds(n), r = 0; r < o.length; r++) {
                        ...
                        t._webAudio && i._node ? i._node.gain.setValueAtTime(e ? 0 : i._volume, a.ctx.currentTime) : i._node && (i._node.muted = !!a._muted || e),
                        t._emit("mute", i._id))
                    }
                    return t
                },
                volume: function() {
                    ...
                    if (0 === r.length)
                        return o._volume;
                    if (1 === r.length || 2 === r.length && "undefined" === typeof r[1] ? o._getSoundIds().indexOf(r[0]) >= 0 ? n = parseInt(r[0], 10) : e = parseFloat(r[0]) : r.length >= 2 && (e = parseFloat(r[0]),
                    n = parseInt(r[1], 10)),
                    !("undefined" !== typeof e && e >= 0 && e <= 1))
                    ...
                    for (var i = 0; i < n.length; i++)
                        ...
                        r[2] || o._stopFade(n[i]),
                        o._webAudio && t._node && !t._muted ? t._node.gain.setValueAtTime(e, a.ctx.currentTime) : t._node && !t._muted && (t._node.volume = e * a.volume()),
                ...
                rate: function() {
                    ...
                    if (0 === r.length)
                        ...
                        o._getSoundIds().indexOf(r[0]) >= 0 ? n = parseInt(r[0], 10) : e = parseFloat(r[0])
                    } else
                    ...
                    for (var i = 0; i < n.length; i++)
                        if (t = o._soundById(n[i])) {
                            ...
                            t._playStart = o._webAudio ? a.ctx.currentTime : t._playStart),
                            t._rate = e,
                            o._webAudio && t._node && t._node.bufferSource ? t._node.bufferSource.playbackRate.setValueAtTime(e, a.ctx.currentTime) : t._node && (t._node.playbackRate = e);
                            var u = o.seek(n[i])
                              , d = 1e3 * ((o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) / 1e3 - u) / Math.abs(t._rate);
                            !o._endTimers[n[i]] && t._paused || (o._clearTimer(n[i]),
                            o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), d)),
                            o._emit("rate", t._id)
                        }
                    return o
                },
                seek: function() {
                    ...
                    if (0 === o.length)
                        ...
                        t._getSoundIds().indexOf(o[0]) >= 0 ? n = parseInt(o[0], 10) : t._sounds.length && (n = t._sounds[0]._id,
                        e = parseFloat(o[0]))
                    } else
                    ...
                    if (r) {
                        if (!("number" === typeof e && e >= 0)) {
                            if (t._webAudio) {
                                var i = t.playing(n) ? a.ctx.currentTime - r._playStart : 0
                                  , u = r._rateSeek ? r._rateSeek - r._seek : 0;
                                return r._seek + (u + i * Math.abs(r._rate))
                            }
                        ...
                        r._ended = !1,
                        t._clearTimer(n),
                        t._webAudio || !r._node || isNaN(r._node.duration) || (r._node.currentTime = e);
                        var s = function() {
                            d && t.play(n, !0),
                            t._emit("seek", n)
                        };
            ...
            u.prototype = {
                ...
                create: function() {
                    ...
                    return n._webAudio ? (e._node = "undefined" === typeof a.ctx.createGain ? a.ctx.createGainNode() : a.ctx.createGain(),
            ...
            var d = {}
              , s = function(e) {
                var n = e._src;
                if (d[n])
                    return e._duration = d[n].duration,
                    void c(e);
              ...
              , l = function(e, n) {
                var t = function() {
                  ...
                  , o = function(e) {
                    e && n._sounds.length > 0 ? (d[n._src] = e,
                    c(n, e)) : t()
                };
            ...
            n.Howler = a,
            n.Howl = i,
            "undefined" !== typeof t.g ? (t.g.HowlerGlobal = r,
            t.g.Howler = a,
            t.g.Howl = i,
            t.g.Sound = u) : "undefined" !== typeof window && (window.HowlerGlobal = r,
            window.Howler = a,
            window.Howl = i,
            window.Sound = u)
        }(),
        function() {
            ...
            Howl.prototype.stereo = function(e, t) {
                ...
                for (var a = o._getSoundIds(t), i = 0; i < a.length; i++) {
                    ...
                    if (u) {
                        ...
                        "spatial" === r ? "undefined" !== typeof u._panner.positionX ? (u._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
            ...
            Howl.prototype.pos = function(e, t, o, r) {
                ...
                for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                    ...
                    if (d) {
                        ...
                        "undefined" !== typeof d._panner.positionX ? (d._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                        d._panner.positionY.setValueAtTime(t, Howler.ctx.currentTime),
                        d._panner.positionZ.setValueAtTime(o, Howler.ctx.currentTime)) : d._panner.setPosition(e, t, o)),
                        a._emit("pos", d._id)
                    }
                }
                return a
            ...
            Howl.prototype.orientation = function(e, t, o, r) {
                ...
                for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                    ...
                    if (d) {
                        ...
                        n(d, "spatial")),
                        "undefined" !== typeof d._panner.orientationX ? (d._panner.orientationX.setValueAtTime(e, Howler.ctx.currentTime),
                        d._panner.orientationY.setValueAtTime(t, Howler.ctx.currentTime),
                        d._panner.orientationZ.setValueAtTime(o, Howler.ctx.currentTime)) : d._panner.setOrientation(e, t, o)),
            ...
            Howl.prototype.pannerAttr = function() {
                ...
                if (1 === a.length) {
                    ...
                    e = a[0],
                    "undefined" === typeof t && (e.pannerAttr || (e.pannerAttr = {
                ...
                for (var i = r._getSoundIds(t), u = 0; u < i.length; u++)
                    if (o = r._soundById(i[u])) {
                        ...
                        var s = o._panner;
                        s ? (s.coneInnerAngle = d.coneInnerAngle,
                        ...
                        s.panningModel = d.panningModel) : (o._pos || (o._pos = r._pos || [0, 0, -.5]),
                        n(o, "spatial"))
                    }
                return r
            }
...
//# sourceMappingURL=1845.e103b46f.chunk.js.map
